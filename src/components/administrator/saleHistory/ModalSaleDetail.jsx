import { InputGroup, Modal, Form, Table} from "react-bootstrap"

const ModalSaleDetail = ( {show, saleInfo, products, setShowModal} ) => {
  return (
    <Modal show={show} centered>
        ...
        <Modal.Footer>
            <button className="btn-main-red" onClick={() => setShowModal(false)}>Cerrar</button>
        </Modal.Footer>
    </Modal>
  )
}
